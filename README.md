...
Ссылка на Apple-профиль остаётся приватной и содержит токен. При скачивании
имя файла и оба отображаемых имени профиля совпадают с доменом установки,
например `dns.example.com.mobileconfig` и `dns.example.com`.
